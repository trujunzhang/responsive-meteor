...
class WidgetAppFollower extends Component {

    render() {
        return (
          <div className="paddedBox_2UY-S box_c4OJj sidebarBox_1-7Yk sidebarBoxPadding_y0KxM">
              <div className="content_DcBqe">
                  <Telescope.components.WidgetHeader message="Follow Us"/>
                  <div className="app_followers sfmsb-follow-social-buttons sfmsb-under sfmsb-square 40 sfmsb-horizontal">
                      <a className="widget-twitter" target="_blank" href="https://www.twitter.com/getpoliticl">
                      ...
                      <a className="widget-facebook" target="_blank" href="https://www.facebook.com/getpoliticl">
