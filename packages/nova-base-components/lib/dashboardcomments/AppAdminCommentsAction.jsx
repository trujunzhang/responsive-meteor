...
class AppAdminCommentsAction extends Component {
...
AppAdminCommentsAction.contextTypes = {
...
AppAdminCommentsAction.displayName = "AppAdminCommentsAction";

module.exports = withRouter(AppAdminCommentsAction);
export default withRouter(AppAdminCommentsAction);
