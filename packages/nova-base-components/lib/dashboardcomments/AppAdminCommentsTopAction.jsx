...
class AppAdminCommentsTopAction extends Component {
    ...
    onTopActionStatusClick(status) {
        ...
        this.context.messages.appManagement.pushCommentFilterStatus(this.props.router, "comments", status);
    }
    ...
    getStatusRows() {
        ...
        const rows = [
            ...
            {title: "Approved", status: "approved", count: (this.props.publishCount ? this.props.publishCount : 0)},
            {title: "Spam", status: "spam", count: (this.props.spamCount ? this.props.spamCount : 0)},
...
AppAdminCommentsTopAction.contextTypes = {
...
AppAdminCommentsTopAction.displayName = "AppAdminCommentsTopAction";

module.exports = withRouter(AppAdminCommentsTopAction);
export default withRouter(AppAdminCommentsTopAction);
