...
class AppAdminCategoriesEditSingle extends Component {
    ...
    constructor(props) {
        ...
        this.state = this.initialState = {
            // detail
            nameValue: category.name ? category.name : '',
            slugValue: category.slug ? category.slug : ''
        };
    }
    ...
    onBulkUpdateSubmitClick() {
        ...
        this.context.actions.call('categories.bulk.edit', [this.props.category._id], modifier, (error, result) => {
          ...
          <tr className="inline-edit-row inline-editor">
              <td colSpan={5} className="colspanchange">
                  ...
                  <p className="inline-edit-save submit">
                      ...
                      <button type="button" className="save button-primary alignright" onClick={this.onBulkUpdateSubmitClick.bind(this)}>Update Category</button>
...
AppAdminCategoriesEditSingle.contextTypes = {
...
AppAdminCategoriesEditSingle.displayName = "AppAdminCategoriesEditSingle";

module.exports = withRouter(AppAdminCategoriesEditSingle);
export default withRouter(AppAdminCategoriesEditSingle);
