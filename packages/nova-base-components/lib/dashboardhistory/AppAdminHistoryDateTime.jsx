...
class AppAdminHistoryDateTime extends Component {
...
AppAdminHistoryDateTime.contextTypes = {
...
AppAdminHistoryDateTime.displayName = "AppAdminHistoryDateTime";

module.exports = withRouter(AppAdminHistoryDateTime);
export default withRouter(AppAdminHistoryDateTime);
