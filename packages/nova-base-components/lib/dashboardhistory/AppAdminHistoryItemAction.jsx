...
class AppAdminHistoryItemAction extends Component {
...
AppAdminHistoryItemAction.contextTypes = {
...
AppAdminHistoryItemAction.displayName = "AppAdminHistoryItemAction";

module.exports = withRouter(AppAdminHistoryItemAction);
export default withRouter(AppAdminHistoryItemAction);
