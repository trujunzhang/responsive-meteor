...
class AppAdminHistoryAction extends Component {
...
AppAdminHistoryAction.contextTypes = {
...
AppAdminHistoryAction.displayName = "AppAdminHistoryAction";

module.exports = withRouter(AppAdminHistoryAction);
export default withRouter(AppAdminHistoryAction);
