...
class RelatedListContainer extends Component {
...
RelatedListContainer.contextTypes = {
...
ReactMixin(RelatedListContainer.prototype, ReactMeteorData);

RelatedListContainer.defaultProps = {
    limit: 10,
    increment: 10,
...
module.exports = RelatedListContainer;
