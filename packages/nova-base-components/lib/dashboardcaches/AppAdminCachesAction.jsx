...
class AppAdminCachesAction extends Component {
...
AppAdminCachesAction.contextTypes = {
...
AppAdminCachesAction.displayName = "AppAdminCachesAction";

module.exports = withRouter(AppAdminCachesAction);
export default withRouter(AppAdminCachesAction);
