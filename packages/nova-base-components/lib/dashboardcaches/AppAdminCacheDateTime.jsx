...
class AppAdminCacheDateTime extends Component {

    constructor(props) {
        super(props);
        let {postedAt} = this.props;
          ...
          <fieldset className="inline-edit-date">
              ...
              <div className="timestamp-wrap">
                  ...
                  <label>
                      ...
                      <input type="text" name="jj" value={this.state.day} size="2" maxLength="2" onChange={this.onChange.bind(this, 'day')}/>
                  </label>,
                  <label>
                      <span className="screen-reader-text">Year</span>
                      <input type="text" name="aa" value={this.state.year} size="4" maxLength="4" onChange={this.onChange.bind(this, 'year')}/>
                  </label>
                  @
                  <label>
                      <span className="screen-reader-text">Hour</span>
                      <input type="text" name="hh" value={this.state.hour} size="2" maxLength="2" onChange={this.onChange.bind(this, 'hour')}/>
                  </label>:
                  <label>
                      <span className="screen-reader-text">Minute</span>
                      <input type="text" name="mn" value={this.state.minute} size="2" maxLength="2" onChange={this.onChange.bind(this, 'minute')}/>
                  </label>
              </div>
...
AppAdminCacheDateTime.contextTypes = {
...
AppAdminCacheDateTime.displayName = "AppAdminCacheDateTime";

module.exports = withRouter(AppAdminCacheDateTime);
export default withRouter(AppAdminCacheDateTime);
