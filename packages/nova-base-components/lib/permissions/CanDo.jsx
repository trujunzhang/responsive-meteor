...
const CanDo = (props, context) => {
    ...
    if (!context.currentUser && props.displayNoPermissionMessage) {
        return (
          ...
          <Telescope.components.UserLoginPopup comp={{object:{showCloseIcon:false,title:'',subtitle:''}}}/>
        );
    }
    ...
    if (permission) {
        ...
        return props.displayNoPermissionMessage ? <Telescope.components.NoPermissionPanel /> : null;
    }
};
