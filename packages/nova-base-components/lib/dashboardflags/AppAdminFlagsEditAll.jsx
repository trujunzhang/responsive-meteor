...
class AppAdminFlagsEditAll extends Component {
...
AppAdminFlagsEditAll.contextTypes = {
...
AppAdminFlagsEditAll.displayName = "AppAdminFlagsEditAll";

module.exports = withRouter(AppAdminFlagsEditAll);
export default withRouter(AppAdminFlagsEditAll);
