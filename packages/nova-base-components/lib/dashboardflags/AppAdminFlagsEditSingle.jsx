...
class AppAdminFlagsEditSingle extends Component {
    ...
    renderFlagedAt() {
        ...
        return (
          <Telescope.components.AppAdminFlagDateTime
    ...
    renderStatus() {
        let status = Posts.getNormalFlagStatusSet();
        return (
          <div className="inline-edit-group wp-clearfix">
...
AppAdminFlagsEditSingle.contextTypes = {
...
AppAdminFlagsEditSingle.displayName = "AppAdminFlagsEditSingle";

module.exports = withRouter(AppAdminFlagsEditSingle);
export default withRouter(AppAdminFlagsEditSingle);
