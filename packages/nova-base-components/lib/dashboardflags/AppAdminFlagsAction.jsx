...
class AppAdminFlagsAction extends Component {
...
AppAdminFlagsAction.contextTypes = {
...
AppAdminFlagsAction.displayName = "AppAdminFlagsAction";

module.exports = withRouter(AppAdminFlagsAction);
export default withRouter(AppAdminFlagsAction);
