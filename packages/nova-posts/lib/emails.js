...
NovaEmail.addEmails({
    ...
    postApproved: {
        ...
        getProperties: Posts.getNotificationProperties,
        subject() {
            return 'Congratulations! Your article on Politicl has been Approved';
        },
        getTestObject: getPost
    },
    ...
    postRejected: {
        ...
        path: "/email/post-rejected/:_id?",
        getProperties: Posts.getNotificationProperties,
        subject() {
            return 'Notification - Your article on Politicl has been Rejected';
        },
        getTestObject: getPost
    },

    postRemoved: {
        template: "postRemoved",
        path: "/email/post-removed/:_id?",
        getProperties: Posts.getNotificationProperties,
        subject({postTitle = "[postTitle]"}) {
            return 'Your post “' + postTitle + '” has been removed';
        },
        getTestObject: getPost
    }
