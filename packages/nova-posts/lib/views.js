...
Posts.views.add("popular.this.week", function (terms) {
    return {
        ...Posts.views.baseParameters,
        options: {}
    };
...
Posts.views.add("related", function (terms) {
    return {
        ...Posts.views.baseParameters,
        options: {}
    };
 ...
 * @summary User posts view
 */
Posts.views.add("userVotePosts", function (terms) {
    return {
        selector: {},
        options: {
            sort: {}
